...
export interface IRoleAccessControl extends Document {
  roleId: string;
  roleName: string;
  employeeId: string;
  employeeName: string;
...
export interface IRoleAccessControlCreate {
  roleId: string;
  roleName: string;
  employeeId: string;
  employeeName: string;
...
export interface IModulePermissionAccess extends Document {
  role: {
    roleId: string;
    roleName: string;
  }
